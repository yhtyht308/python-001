...
class IncomeTaxCalculator(object):
	...
	def calc_income_tax_and_remain(cls,income):
		social_insurance_money=cls.calc_socail_insurance_money(income)
		real_income=income-socail_insurance_money
	...
	def calc_for_all_userdata(self):
		...
		for employee_id,income in self.userdata:
			...
			tax,remain=self.calc_inscome_tax_and_remain(income)
	...
	def export(self,default='csv'):
		...
		with open(agrs.export_path,'w',newline='') as f:
			writer=csv.writer(f)
